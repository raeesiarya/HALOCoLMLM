...
from lmlm_audit.cli.jobs import DEFAULT_DATABASE_PATH, DEFAULT_OUTPUT_DIR
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            "Database JSON to audit. When provided without --prompt-files, run all "
            "prompt files in the sibling prompts/<variant>/ directory if present."
        ),
    )
    parser.add_argument(
        "--output-dir",
